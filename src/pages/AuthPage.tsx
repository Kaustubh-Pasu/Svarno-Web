...
const AuthPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('🚀 AuthPage form submitted:', { mode, email, name })

    try {
      if (mode === 'login') {
        console.log('🔐 AuthPage calling signIn function...')
        ...
        console.log('📝 AuthPage calling signUp function...')
  ...
  return (
    <div className="min-h-screen bg-background-950 flex items-center justify-center p-4">
      ...
      <motion.button
        ...
        onClick={() => navigate('/')}
        className="absolute top-6 left-6 flex items-center space-x-2 text-background-400 hover:text-background-200 transition-colors"
      >
